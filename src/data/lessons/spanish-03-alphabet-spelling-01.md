...
Welcome to **Spanish Lesson 02**. In this lesson, you will learn the Spanish alphabet, how to ask how a word is spelled, how to spell names, and key pronunciation rules for sounding out Spanish words!

---

## 1. Asking How Words Are Written (Preguntar cómo se escribe)

Here are key phrases to ask someone how to spell a word or name:

### How do you spell...?
**¿Cómo se escribe...?**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=%C2%BFC%C3%B3mo%20se%20escribe%3F" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### How is your name written?
**¿Cómo se escribe tu nombre?**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=%C2%BFC%C3%B3mo%20se%20escribe%20tu%20nombre%3F" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### It is spelled with...
**Se escribe con...**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Se%20escribe%20con" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

---

## 2. The Spanish Alphabet (El Abecedario)
...
## 3. Spelling Names Out Loud (Deletrear nombres)

When spelling names in Spanish, you sound out letter by letter. Practice spelling these common names out loud:

### Maria (M - A - R - Í - A)
**Eme - a - ere - i - a**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Eme%2C%20a%2C%20ere%2C%20i%2C%20a" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### Carlos (C - A - R - L - O - S)
**Ce - a - ere - ele - o - ese**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Ce%2C%20a%2C%20ere%2C%20ele%2C%20o%2C%20ese" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### Ana (A - N - A)
**A - ene - a**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=A%2C%20ene%2C%20a" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

---

## 4. Sounding Out Words (Pronunciación)

Spanish is a **phonetic language**, meaning words are spoken almost exactly as they are written! Key rules to keep in mind:

### The silent H (La 'H' muda)
The letter **H** is always completely silent in Spanish.

**Hola** (Sounds like *"O-la"*)
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Hola" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### The J and G sound (La 'J' y la 'G')
The letter **J** sounds like an English *H* (or a raspy breath).

**Jirafa**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Jirafa" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### The Ñ sound (La 'Ñ' eñe)
**Ñ** makes a "ny" sound, like the middle of *canyon*.

**España**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Espa%C3%B1a" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

### The double L sound (La 'LL' doble ele)
**LL** sounds like the *Y* in "yes".

**Llama**
<audio controls src="https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=es&q=Llama" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
...
- **Practice** spelling your own name out loud in Spanish using the letter sounds from Section 2.
- **Listen** to the audio clips for tricky letters like **H**, **J**, **Ñ**, and **LL**.
- Take the upcoming **Alphabet & Spelling Test** to solidify your skills!